			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">HOME</strong> / <small>编辑管理</small>
					</div>
				</div>
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
						<form action="${pageContext.request.contextPath}/admin/updateAdmin" method="post" class="am-form am-form-horizontal" id="form-with-tooltip">
