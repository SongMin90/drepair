			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">HOME</strong> / <small>全部学生</small>
					</div>
				</div>
						...
						<form id="stus" class="am-form">
							<table
								...
								<tbody>
									<c:forEach items="${stuList}" var="stu">
										<tr>
											<td><input name="ids" type="checkbox" value="${stu.stuId}" /></td>
											<td>${stu.stuId}</td>
											<td>${stu.stuPwd}</td>
											<th>${stu.stuPhone}</th>
											<td>
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
														<button type="button" onclick="location.href='${pageContext.request.contextPath}/stu/editStu?stuId=${stu.stuId}'"
															class="am-btn am-btn-default am-btn-xs am-text-secondary" title="编辑">
															<span class="am-icon-pencil-square-o"></span>
														</button>
														<button type="button" onclick="return delStu('${stu.stuId}')"
									...
									$('#del-confirm').modal({
									      ...
									      onConfirm: function(e) {
									    	  $.ajax({
												type:'POST',
												async:false,
												url:'${pageContext.request.contextPath}/stu/delStu',
												data:"stuId="+stuId,
												dataType:'json',
								...
								function delAll() {
									...
									onConfirm: function(e) {
										$.ajax({
											type:'POST',
											async:false,
											url:'${pageContext.request.contextPath}/stu/delAllStus',
											data:$('#stus').serialize(),
											dataType:'json',
											success:function(data){
												alert(data.result);
							...
							<div class="am-cf">
								...
								<div class="am-fr">
									<ul class="am-pagination">
										<div data-am-page="{pages:${pageCount},curr:${nowPage},jump:'${pageContext.request.contextPath}/stu/allStu?nowPage=%page%&size=${size}'}"></div>
									</ul>
								</div>
							</div>
							<!-- 每页显示大小下拉 -->
							<script type="text/javascript">
								...
								$("#tableSize").change(function () {  
						            ...
						            window.location.href='${pageContext.request.contextPath}/stu/allStu?size='+size;
						        });
							</script>
							<hr />
							<p>注：.....</p>
