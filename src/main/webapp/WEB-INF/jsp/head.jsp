...
<link rel="icon" type="image/png" href="${pageContext.request.contextPath}/admin/assets/i/favicon.ico">
...
<script src="${pageContext.request.contextPath}/admin/assets/js/amazeui.page.js"></script>
</head>