...
<head lang="en">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/assets/css/tr.css"/>
</head>
<body>
				...
				<div class="am-viewport" style="overflow: hidden; position: relative;">
					<ul class="am-slides" style="width: 800%; transition-duration: 0s; transform: translate3d(-1000px, 0px, 0px);">
						<li class="clone" aria-hidden="true" style="width: 1000px; float: left; display: block;">
							<img src="${pageContext.request.contextPath}/admin/assets/images/netdisk-slider-p2.png" draggable="false">
						</li>
						<li class="am-active-slide" style="width: 1000px; float: left; display: block;">
							<img src="${pageContext.request.contextPath}/admin/assets/images/netdisk-slider-p1.png" draggable="false">
						</li>
		...
		<div class="tr-yunpan-container am-container am-container-collapse am-vertical-align">
			<div class="am-vertical-align-middle am-g am-g-collapse" style="width:100%;">
				...
				<div class="tr-yunpan-login-container am-container am-u-md-4 am-u-md-push-8 am-u-sm-10 am-u-sm-push-1">
					<form id="yunpan-login-form" class="am-form am-padding-xl am-padding-bottom-sm" method="post" action="${pageContext.request.contextPath}/admin/login" novalidate="novalidate">
						...
						<div class="am-g am-padding-sm">
							...
							<div class="am-form-group am-form-icon">
								...
								<input type="password" name="password" value="${password}" class="am-form-field am-radius" placeholder="密码" minlength="6" required/>
							</div>
							<div class="am-form-group am-form-icon am-g">
								<div class="am-u-sm-7">
									<span class="am-icon-check"></span>
									<input type="text" name="validateCode" class="am-form-field am-radius" placeholder="验证码" minlength="4" maxlength="4" required/>
								</div>
								<div class="am-u-sm-5 am-text-right">
									<img onclick="this.setAttribute('src','${pageContext.request.contextPath}/admin/getImgCode?time='+new Date());" src="${pageContext.request.contextPath}/admin/getImgCode" alt="验证码" class="am-img-thumbnail">
								</div>
							</div>
	...
	<!-- Up -->
	<div data-am-widget="gotop" class="am-gotop am-gotop-fixed am-no-layout am-active" id="tr-gotop">
	    <a href="#top" title="" class="">
	    	<i class="am-icon am-icon-arrow-up am-icon-sm"></i>
	    </a>
    </div>
	...
	<script src="${pageContext.request.contextPath}/admin/assets/js/tr.js"></script>
